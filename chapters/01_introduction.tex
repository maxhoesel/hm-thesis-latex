...
\begin{figure}[!tbp]
    \centering
    \subfloat[HM Logo][The logo.]{\includegraphics[height=0.2\textheight]{logos/hm.png}\label{fig:tum1}}
    \hfill
    \subfloat[TUM Slide][The parabolic slide at TUMs Faculty for Mathematics and Computer Science Building.]{\includegraphics[height=0.2\textheight]{figures/tum}\label{fig:tum2}}
...
\Glspl{ddye}, \gls{r0}, \gls{R0}, and \gls{kdeac}. Also, the \glspl{hm} has many \glspl{computer}, not only one \Gls{computer}. Subsequent acronym usage will only print the short version of \glspl{hma} (take care of plural, if needed!), like here with \gls{hma}, too. It can also be --> \glsdisp{hm}{hidden}\footnote{Example for a hidden HM glossary entry.} <--.
